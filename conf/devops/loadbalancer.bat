...
:action
    ...
    set DC_ENV=%CLI_DIRECTORY%\cache\docker-compose-nginx-lb.env
    set DC_CONF=%CLI_DIRECTORY%\conf\docker\docker-compose-nginx-lb.yml
...
:short
    echo Nginx default load balancing.
    goto end

:help
    echo This is a Command Line Interface with project %PROJECT_NAME%
    echo Startup Server with nginx load banancing configuration.
    echo.
    echo Options:
